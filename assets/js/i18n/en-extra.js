...
(function() {
  ...
  window.TIU_EN.officers = {
    ...
    desc: 'Five personnel dispatched by ORACLE to the Korean branch. Currently operating the classified Gangwon outpost on observation duty.',
    captionStatus: 'OPERATIONAL',
    captionSync: 'ORACLE SYNC: ACTIVE',
    members: [
      { img: 'assets/img/kr-lee-jungchul.png', name: 'LEE JUNG-CHUL', code: 'PILEHEAD',   role: 'COMMANDER',   bg: 'ORACLE appointee · Former ROK Army Special Forces' },
      ...
      { img: 'assets/img/kr-lim-jaehyuk.png',  name: 'LIM JAE-HYUK',  code: 'SYS-01',     role: 'TECHNICIAN',  bg: 'ORACLE terminal · Systems' }
    ]
  };
  ...
  window.TIU_EN.gameCta = {
    ...
    body: 'You are appointed as the new commander of KR-INIT-001.<br>Open the ORACLE terminal and execute directives.',
  ...
  window.TIU_EN.voices = {
    ...
    items: [
      ...
      },
      {
        ...
        cite: 'ORACLE Environmental Analysis Report'
      }
    ]
  };
})();
