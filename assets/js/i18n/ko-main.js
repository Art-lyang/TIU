...
(function() {
  ...
  window.TIU_KO.categories = {
    ...
    items: [
      { id: 'factions',  icon: '⚡', name: 'FACTIONS',  sub: '4대 세력 · 관계도 · 철학',                  href: '#', ready: false },
      { id: 'threats',   icon: '🧬', name: 'THREATS',   sub: 'EV-Σ · 변이체 · 구역 · 검역',                href: '#', ready: false },
      { id: 'records',   icon: '📡', name: 'RECORDS',   sub: '사건 타임라인 · 공개본 누락 · 교신',         href: '#', ready: false },
      { id: 'incidents', icon: '📋', name: 'INCIDENTS', sub: '첫 사건 · 도시전설 · 서브스토리',            href: '#', ready: false },
      { id: 'specimens', icon: '🧪', name: 'SPECIMENS', sub: '변이체 색인 · SPEC 도감',                    href: '#', ready: false },
      { id: 'profiles',  icon: '👤', name: 'PROFILES',  sub: '글로벌 인물 · 세력별 분류',                  href: '#', ready: false },
      { id: 'database',  icon: '🗄',  name: 'DATABASE',  sub: '전체 색인 · PA-TERMINAL',                     href: '#', ready: false }
    ],
  ...
  window.TIU_KO.statusWall = {
    ...
    desc: '실시간 관측 데이터. 수치는 ORACLE 센서 네트워크에서 자동 갱신된다.',
    cells: [
  ...
  window.TIU_KO.threatGrid = {
    ...
    factions: [
      { id: 'observer',   name: 'ORACLE',     status: 'MONITORING', last: '실시간 관측',                 threat: 100, variant: 'obs',  logo: 'assets/img/logo-observer.webp' },
