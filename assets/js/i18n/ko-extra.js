...
(function() {
  ...
  window.TIU_KO.officers = {
    ...
    members: [
      { img: 'assets/img/kr-lee-jungchul.png', name: '이중철',  code: 'PILEHEAD',   role: 'COMMANDER',   bg: '상위 지명 / 전 육군 특수부대 장교' },
      ...
      { img: 'assets/img/kr-lim-jaehyuk.png',  name: '임재혁',  code: 'SYS-01',     role: 'TECHNICIAN',  bg: '폐쇄 단말기 · 시스템 관리' }
    ]
  };
