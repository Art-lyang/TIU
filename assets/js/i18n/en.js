...
window.TIU_EN = {
  ...
  specIndex: {
    ...
    items: [
      { code: 'SPEC-001', name: 'Infected Mannequin', risk: 'PHASE 1 / CLOSE RANGE', tone: 'amber', img: 'assets/img/specs/mannequin-cluster.webp', visual: 'MANNEQUIN CLUSTER', type: 'M-TYPE humanoid', rule: 'No solo approach within 3m, even if stationary', desc: 'Nearly indistinguishable from a human body while still. On stimulus, it can switch to attack within 0.3 seconds, delaying the line between rescue target and threat.' },
      { code: 'SPEC-003', name: 'Brood Drone', risk: 'H-TYPE / HIVE', tone: 'red', img: 'assets/img/specs/brood-drone-closeup.webp', visual: 'BROOD CLOSEUP', type: 'Hive subordinate', rule: 'Avoid attrition until core separation is confirmed', desc: 'Low independent will, fast response to hive command. Some separated cases go inactive within 12 hours, but until then they exhaust containment lines.' },
      { code: 'SPEC-004', name: 'Seed Spreader', risk: 'S-TYPE / CRITICAL', tone: 'red', img: 'assets/img/specs/seed-spreader.webp', visual: 'SILENT BELT NODE', type: 'Fixed spreader entity', rule: 'Control approach radius; calculate spore backflow before burn', desc: 'It does not move because wind and soil move for it. Destruction can trigger explosive spore release, so simple burning may become secondary spread.' },
      { code: 'SPEC-008', name: 'Spore Phantom', risk: 'S-TYPE / AIRBORNE', tone: 'red', img: 'assets/img/specs/spore-phantom.webp', visual: 'SPORE PHANTOM', type: 'Spore / light-reactive', rule: 'Seal ventilation, control lighting, log inhalation exposure', desc: 'Disperses under light conditions and resists physical removal. Inhalation exposure expands quarantine cost from individual to household level.' },
      { code: 'SPEC-011', name: 'Shell Talker', risk: 'VOICE MIMIC', tone: 'amber', img: 'assets/img/specs/spec_011_shelltalker.jpg', visual: 'VOICE INCIDENT CCTV', type: 'Voice mimic', rule: 'Do not answer alone when a victim voice is heard', desc: 'Mimics the voices of missing people or family members to make doors open. It turns horror into the cost of relationships rather than simple attack.' },
      { code: 'SPEC-012', name: 'Blood Pit', risk: 'ENVIRONMENTAL', tone: 'red', img: 'assets/img/specs/spec_012_bloodpit.jpg', visual: 'CONTAMINATED ZONE STILL', type: 'Environmental contaminant', rule: 'Burn contact surfaces; do not remove recovered goods', desc: 'Uses red mucilage and digestive enzymes to break down organic matter. The incident site itself becomes the entity, forcing rescue and evidence preservation to collide.' },
      { code: 'SPEC-015', name: 'Brain Seeker', risk: 'H-TYPE / EXILED', tone: 'red', img: 'assets/img/specs/spec_015_brainseeker.jpg', visual: 'EXILED HIVE TRACE', type: 'Learning exiled entity', rule: 'Avoid direct engagement; prioritize trace tracking and civilian evacuation', desc: 'A class of entities whose learning capacity rises after severance from hive connection. Named incidents and coordinates are excluded from the public index.' },
      { code: 'PHASE 0', name: 'Latent Host', risk: 'CIVILIAN COST', tone: 'green', img: 'assets/img/specs/infection-transition.webp', visual: 'INFECTION TRANSITION', type: 'Asymptomatic infection record', rule: 'Do not delete records; restrict access instead', desc: 'Externally indistinguishable from any citizen. Schools, insurance, marriage, military duty, and visitation rights destabilize first, making it a core social-pressure axis.' }
    ]
  },
  world: {
